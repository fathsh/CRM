...
class ClassList(models.Model):
    ...
    class_type_choicse = ((0, "脱产"), (1, "周末"), (2, "网络班"))
    class_type = models.SmallIntegerField(choices=class_type_choicse, default=0)
...
class StudyRecord(models.Model):
    ...
    date = models.DateField(auto_now_add=True)
    def __str__(self):
        return "{} {} {}".format(self.couse_record, self.student, self.score)
